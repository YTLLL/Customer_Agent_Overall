...
from agent.app.agents.new_reasoning_graph import ReasoningGraph
# 创建路由器
...
async def create_or_continue_conversation(
    ...
    reasoning_graph: ReasoningGraph = Depends(get_reasoning_graph)
):
    """创建新对话或继续现有对话"""
    # 查找用户现有的活跃对话
    ...
    background_tasks.add_task(
        reasoning_graph.process_request,
        conversation.id,
        request.message
    )
